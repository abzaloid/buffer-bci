...
figure(fig);
set(fig,'Name','BCI based Wheelchair Control','units','normalized',...%'position',[0 0 1 1],...
...
for i=1:numel(ags);
  ...
  switch agents(x,y);
   case key.pacman;  agentsh(x,y) = patch(x,y,cmap(key.pacman+1,:),...
...
scoreh=text(1,.5,'Score : 0','HorizontalAlignment','right','color',[0 0 0]);
